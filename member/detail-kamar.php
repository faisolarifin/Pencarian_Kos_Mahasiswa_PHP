...
$no=1;
$result = $konek->query("SELECT kos.id_kos, kos.nama, kos.id_akun, kamar.*, harga.* FROM kos, kamar, harga WHERE kos.id_kos=kamar.id_kos AND kamar.id_kamar=harga.id_kamar AND kamar.id_kamar='$id' AND kos.id_akun='".$_SESSION['id']."'");
