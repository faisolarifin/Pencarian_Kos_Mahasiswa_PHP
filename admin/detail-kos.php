...
$qry = $konek->query("SELECT akun.id_akun, akun.nama as x, kos.*, kategori.* FROM akun, kos, kategori WHERE akun.id_akun=kos.id_akun AND kos.id_kat=kategori.id_kat AND id_kos='$id'");
